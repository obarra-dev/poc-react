export function TabDataNotFound({
  ...
  return (
    <span className="lift-tab__not-found-message">
      <div className="nx-card-container">
        <section className="nx-card nx-card--equal">
          ...
          <header className="nx-card__header">
            <h2 className="nx-h2 nx-h2--card-header lift-tab__not-found-data-header">
              {tabType} data is unavailable in this report.
            </h2>
          </header>
          <div className="nx-card__content">
            <div className="nx-card__text lift-tab__not-found-data-message">
              {message}
            </div>
          </div>
        </section>
